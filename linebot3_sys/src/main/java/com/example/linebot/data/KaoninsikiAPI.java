...
@Repository
public class KaoninsikiAPI {
    // あなたのEC2の画像の送付先 application.propertiesファイルから読み込まれる
    @Value("${kaoninsiki.api.url}")
    ...
    public KaoninsikiAPI(RestTemplateBuilder restTemplateBuilder) {
        this.restTemplate = restTemplateBuilder.build();
    }

    public KaoninsikiResponse play(Resource imageResource) {
        ...
        ResponseEntity<KaoninsikiResponse> response = restTemplate.postForEntity(API_URL, formEntity, KaoninsikiResponse.class);
